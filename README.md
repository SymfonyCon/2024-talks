...
## Keynote · Twig: Still relevent in 2025?  <sub>_by [Fabien Potencier](#by-fabien-potencier)_</sub>
...
## HTTP compression in Symfony apps  <sub>_by [Kévin Dunglas](README.md#by-kévin-dunglas)_</sub>
...
## From Translations to Multi Dimension Entities  <sub>_by [Alexander Schranz](README.md#by-alexander-schranz)_</sub>
...
## Crafting Hybrid PHP-Go CLIs with Symfony Console  <sub>_by [Antonis Kalipetis](README.md#by-antonis-kalipetis)_</sub>
...
## Symfony Form - Practical use cases  <sub>_by [Alexandre Salomé](README.md#by-alexandre-salomé)_</sub>
...
## Symfony UX: 2024 Highlights & What’s Next  <sub>_by [Simon André](README.md#by-simon-andré)_</sub>
...
## Machine Learning Inference in PHP by example: leverage ONNX and Transformers on Symfony  <sub>_by [Guillaume Moigneu](README.md#by-guillaume-moigneu)_</sub>
...
## A brand-new way to serialize data in Symfony  <sub>_by [Mathias Arlaud](README.md#by-mathias-arlaud)_</sub>
...
~~Video~~  
~~Blog post~~  
[New Symfony Component: `symfony/json-encoder`](https://github.com/symfony/json-encoder) <sup>([merged Pull Request](https://github.com/symfony/symfony/pull/51718))</sup>
...
## Flexibility in the Face of Uncertainty  <sub>_by [Johannes Wachter](README.md#by-johannes-wachter)_</sub>
...
## Building a Fraud Prevention component using Symfony  <sub>_by [Moritz Schuh](README.md#by-moritz-schuh)_</sub>
...
## Refactor your code - refactor yourself  <sub>_by [Peter Dietrich](README.md#by-peter-dietrich)_</sub>
...
## Greener code with Symfony  <sub>_by [Michelle Sanver](README.md#by-michelle-sanver)_</sub>
...
## Flawless collaboration between front and back developers  <sub>_by [A. Delaporte](README.md#by-augustin-delaporte) & [F. Huck](README.md#by-florent-huck)_</sub>
...
## Who did that? Auditing data changes at scale  <sub>_by [Sebastian Plagemann](README.md#by-sebastian-plagemann)_</sub>
...
## An Unholy Bond: Harmonizing Dev and Marketing  <sub>_by [Celeste Van Der Watt](README.md#by-celeste-van-der-watt)_</sub>
...
## Cutting-Edge Symfony Pipelines with Dagger  <sub>_by [Paul Dragoonis](README.md#by-paul-dragoonis)_</sub>
...
## Break Things Fast: Accelerated QA and Testing with Upsun  <sub>_by [Greg Qualls](README.md#by-greg-qualls)_</sub>
...
## Demystifying Dependency Injection in Symfony  <sub>_by [Dave Liddament](README.md#by-dave-liddament)_</sub>
...
## Symfony Mapper component  <sub>_by [Antoine Bluchet](README.md#by-antoine-bluchet)_</sub>
...
<abbr title="Work In Progress">WIP:</abbr> [New Symfony Component`symfony/object-mapper`](https://github.com/symfony/symfony/pull/51741)
...
## Composer Behind the Scenes  <sub>_by [Nils Adermann](README.md#by-nils-adermann)_</sub>
...
## Can Postgres cover your NoSQL needs?  <sub>_by [David Buchmann](README.md#by-david-buchmann)_</sub>
...
## 42 best practices for Symfony, a decade later  <sub>_by [Tugdual Saunier](README.md#by-tugdual-saunier)_</sub>
...
## Carry out the best audit for your client  <sub>_by [Marie Minasyan](README.md#by-marie-minasyan)_</sub>
...
## Designing for Change: Extensibility points in practice  <sub>_by [Adam Wójs](README.md#by-adam-wójs)_</sub>
...
## Platforms & Frameworks Eat Culture for Breakfast  <sub>_by [Nigel Kersten](README.md#by-nigel-kersten)_</sub>
...
## The missing Gotenberg Bundle. Components, Assemble!  <sub>_by [A. Roches](README.md#by-adrien-roches) & [H. Lenoir](README.md#by-hubert-lenoir)_</sub>
...
## Strict PHP  <sub>_by [Alexander M. Turek](README.md#by-alexander-m-turek)_</sub>
...
## Bulletproofing for Black Friday  <sub>_by [Thomas di Luccio](README.md#by-thomas-di-luccio)_</sub>
...
## Crafting a Microservice That Fits Your Needs  <sub>_by [Haylee Millar](README.md#by-haylee-millar)_</sub>
...
## How to migrate from Cron to Symfony Scheduler  <sub>_by [Viktor Pikaev](README.md#by-viktor-pikaev)_</sub>
...
## GraphQL, REST or RPC? Making the choice!  <sub>_by [](README.md#by-)</sub>
...
## Symfony Notifier : Return of the Mailman  <sub>_by [](README.md#by-)</sub>
...
## The Role of Empathy in Technical Writing  <sub>_by [](README.md#by-)</sub>
...
## Resurrecting the Dead  <sub>_by [](README.md#by-)</sub>
...
## Component Thinking with Symfony  <sub>_by [](README.md#by-)</sub>
...
## Running Symfony in a Multi-Process Container  <sub>_by [](README.md#by-)</sub>
...
## From Pickles to Pie: Sweeten Your PHP Extension Installs  <sub>_by [](README.md#by-)</sub>
...
## Modern Approaches to Web Security: Stateless CSRF Protection Explained  <sub>_by [](README.md#by-)</sub>
...
## Symfony Authentication: What’s next?  <sub>_by [](README.md#by-)</sub>
...
## Keynote · Twig: Still relevent in 2025?  <sub>by [Fabien Potencier](README.md#by-fabien-potencier)</sub>
...
## HTTP compression in Symfony apps  <sub>by [Kévin Dunglas](README.md#by-kévin-dunglas)</sub>
...
## Crafting Hybrid PHP-Go CLIs with Symfony Console  <sub>_by [](README.md#by-)_</sub>
...
## Symfony Form - Practical use cases  <sub>_by [](README.md#by-)_</sub>
...
## Symfony UX: 2024 Highlights & What’s Next  <sub>_by [](README.md#by-)_</sub>
...
## Machine Learning Inference in PHP by example: leverage ONNX and Transformers on Symfony  <sub>_by [](README.md#by-)_</sub>
...
## A brand-new way to serialize data in Symfony  <sub>_by [](README.md#by-)_</sub>
...
## Flexibility in the Face of Uncertainty  <sub>_by [](README.md#by-)_</sub>
...
## Building a Fraud Prevention component using Symfony  <sub>_by [](README.md#by-)_</sub>
...
## Refactor your code - refactor yourself  <sub>_by [](README.md#by-)_</sub>
...
## Greener code with Symfony  <sub>_by [](README.md#by-)_</sub>
...
## Flawless collaboration between front and back developers  <sub>_by [](README.md#by-)_</sub>
...
## Who did that? Auditing data changes at scale  <sub>_by [](README.md#by-)_</sub>
...
## An Unholy Bond: Harmonizing Dev and Marketing  <sub>_by [](README.md#by-)_</sub>
...
## Cutting-Edge Symfony Pipelines with Dagger  <sub>_by [](README.md#by-)_</sub>
...
## Break Things Fast: Accelerated QA and Testing with Upsun  <sub>_by [](README.md#by-)_</sub>
...
## Demystifying Dependency Injection in Symfony  <sub>_by [](README.md#by-)_</sub>
...
## Symfony Mapper component  <sub>_by [](README.md#by-)_</sub>
...
## Composer Behind the Scenes  <sub>_by [](README.md#by-)_</sub>
...
## Can Postgres cover your NoSQL needs?  <sub>_by [](README.md#by-)_</sub>
...
## 42 best practices for Symfony, a decade later  <sub>_by [](README.md#by-)_</sub>
...
## Designing for Change: Extensibility points in practice  <sub>_by [](README.md#by-)_</sub>
...
## Platforms & Frameworks Eat Culture for Breakfast  <sub>_by [](README.md#by-)_</sub>
...
## Strict PHP  <sub>_by [](README.md#by-)_</sub>
...
## Bulletproofing for Black Friday  <sub>_by [](README.md#by-)_</sub>
...
## How to migrate from Cron to Symfony Scheduler  <sub>_by [](README.md#by-)_</sub>
...
## GraphQL, REST or RPC? Making the choice!  <sub>_by [](README.md#by-)_</sub>
...
## Symfony Notifier : Return of the Mailman  <sub>_by [](README.md#by-)_</sub>
...
## The Role of Empathy in Technical Writing  <sub>_by [](README.md#by-)_</sub>
...
## Resurrecting the Dead  <sub>_by [](README.md#by-)_</sub>
...
## Component Thinking with Symfony  <sub>_by [](README.md#by-)_</sub>
...
## Running Symfony in a Multi-Process Container  <sub>_by [](README.md#by-)_</sub>
...
## From Pickles to Pie: Sweeten Your PHP Extension Installs  <sub>_by [](README.md#by-)_</sub>
...
## Modern Approaches to Web Security: Stateless CSRF Protection Explained  <sub>_by [](README.md#by-)_</sub>
...
## Symfony Authentication: What’s next?  <sub>_by [](README.md#by-)_</sub>
